                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="nyskra.php" method="POST" class="form-signup">
                              ...
                              <!--  <label for="inputPassword" class="sr-only">Staðfesta Lykilorð</label> -->
                               <!-- <input type="password" id="inputPassword" class="form-control" placeholder="Staðfesta lykilorð" required="10"> -->
                                <button class="btn btn-lg btn-primary btn-block" type="submit">Nýskrá</button>       
                            </form>
		            ...
		            <div class="modal-content">
		              ...
		              <div class="modal-body">
		                <form action="innskra.php" method="POST" class="form-signin">
		                	<label for="username" class="sr-only">Notendanafn</label>
		                	<input type="username" id="user" name="user" class="form-control" placeholder="Notendanafn" required autofocus>
		                	<label for="inputPassword" class="sr-only">Lykilorð</label>
		                	<input type="password" id="pass" name="pass" class="form-control" placeholder="Lykilorð" required="10">
